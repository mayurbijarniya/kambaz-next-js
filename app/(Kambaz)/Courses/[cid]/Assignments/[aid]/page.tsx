...
export default function AssignmentPage() {
  ...
  // View-only mode for existing assignments
  if (!isNew && existingAssignment) {
    return (
      <Container fluid id="wd-assignments-editor" className="py-2">
        <Form>
          ...
          <Row className="g-3 mb-4">
            <Col sm={12} md={8} lg={7}>
              <Form.Group controlId="wd-name">
                ...
                <Form.Control value={existingAssignment.title} readOnly />
              </Form.Group>
            </Col>
          </Row>
          ...
          <Row className="g-3 mb-4">
            <Col sm={12} md={8} lg={7}>
              <div className="border rounded p-3">
                <p className="mb-2">
                  The assignment <span className="fw-semibold">{existingAssignment.title}</span> is <span className="text-danger">available online</span>.
                </p>
                <p className="mb-2">
                  Available <strong>{formatDateTime(existingAssignment.availableOn)}</strong> &nbsp;|&nbsp; Due{" "}
                  <strong>{formatDateTime(existingAssignment.dueOn)}</strong>
                </p>
          ...
          <Row className="align-items-center g-3 mb-3">
            ...
            <Col sm={9} md={6} lg={5}>
              <Form.Control id="wd-points" type="number" value={existingAssignment.points ?? 0} readOnly />
            </Col>
          </Row>
          ...
          <Row className="align-items-center g-3 mb-3">
            ...
            <Col sm={9} md={6} lg={5}>
              <Form.Select id="wd-group" defaultValue="ASSIGNMENTS" disabled>
          ...
          <Row className="align-items-center g-3 mb-3">
            ...
            <Col sm={9} md={6} lg={5}>
              <Form.Select id="wd-display-grade-as" defaultValue="Percentage" disabled>
            ...
            <Col sm={9} md={6} lg={5}>
              <div className="border rounded p-3">
                ...
                <Form.Check
                  ...
                  disabled
                />
                <Form.Check id="wd-file-upload" label="File Uploads" disabled />
              </div>
            </Col>
          </Row>
            ...
            <Col sm={9} md={6} lg={5}>
              <div className="border rounded p-3">
                <Form.Group className="mb-3">
                  ...
                  <Form.Control id="wd-assign-to" defaultValue="Everyone" readOnly />
                </Form.Group>
                ...
                <Row className="g-3">
                  <Col xs={12}>
                    <Form.Group controlId="wd-due-date">
                      ...
                      <Form.Control
                        type="datetime-local"
                        step="60"
                        value={existingAssignment.dueOn?.slice(0, 16) ?? ""}
                        readOnly
                      />
                    </Form.Group>
                  </Col>
                  <Col xs={6}>
                    <Form.Group controlId="wd-available-from">
                      ...
                      <Form.Control
                        type="datetime-local"
                        step="60"
                        value={existingAssignment.availableOn?.slice(0, 16) ?? ""}
                        readOnly
                      />
                    </Form.Group>
                  </Col>
                  <Col xs={6}>
                    <Form.Group controlId="wd-available-until">
                      ...
                      <Form.Control
                        type="datetime-local"
                        value={existingAssignment.availableUntil?.slice(0, 16) ?? ""}
                        readOnly
                      />
                    </Form.Group>
                  </Col>
